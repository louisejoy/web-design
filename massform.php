<html>
<head>
	<title>Thanks Giving Mass</title>
...
<body>
    <div class="modal-content" style="width: 1000px;margin-left: auto;margin-right: auto">
        <div class="modal-header">
            <h4 class="modal-title col-md-8">Thanks Giving Mass Form</h4>
            <h5 class="dontprint modal-title col-md-4" style="text-align: right;"><a href="mass.php" style="text-decoration: none;color: black;"><span class="glyphicon glyphicon-circle-arrow-left"></span> Go Back</a></h5>
            ...
            <form action="" method="POST">
                <div class="form-group" style="margin-left: -15px">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="Name_of_Client" id="Name_of_Client" placeholder="Enter Name of Client" required="">
                    </div>

                    <div class="col-md-6">
                        <h5 style="font-family:Lucida Calligraphy">Type of Thankgiving Mass:</h5> 
                        <select type="text" name="type" id="type" class="form-control">
                                <option>Select type of mass</option>
    ...
    <script type="text/javascript">
        $('#submitBtn').click(function(){
            ...
            $('#cname').text($('#Name_of_Client').val());
            $('#typ').text($('#type').val());
            $('#cont').text($('#contact').val());
	...
	<?php 
                ...
                if(!$setout){
                    ...
                    $insertClient=$conn->query("INSERT INTO client_tbl (client_id, client_fname, client_mname, client_lname, client_gender, client_contact, client_email, submitted, client_order) VALUES ('','$cfname','$cmname','$clname','$cgender','$contact','$cemail',NOW(),'mass')");
                    ...
                    if(!$insertClient){
                        ...
                        if($clientRow>0){
                            ...
                            if(!$insertDate){
                                ...
                                $insertFuneral=$conn->query("INSERT INTO mass_tbl (mass_id, mass_name, mass_type, mass_other, client_id) VALUES ('','$cname','$type','$fcmnt','$clientID')");
                                if(!$insertClient && !$insertFuneral){
                                    die("<script>
                                            alert('Error encountered, Reloading page');
                                            window.location.href='massform.php';
                                         </script>");
                                }
                                else{
