        ...
        <div id="parentDiv">
            ...
            <div>
                ...
                <?php
                    ...
                    $count="SELECT client_tbl.*, date_tbl.* FROM client_tbl, date_tbl WHERE ordertype=0 AND client_tbl.client_id=date_tbl.client_id";
                ...
                <?php
                    $selectAll=$conn->query("SELECT client_tbl.*, date_tbl.*, wed_tbl.wed_groom, wed_tbl.wed_bride FROM client_tbl, date_tbl, wed_tbl WHERE ordertype=0 AND client_order='wedding' AND client_tbl.client_id=date_tbl.client_id AND client_tbl.client_id=wed_tbl.client_id");
                    ...
                    if($numrows<=0){
                        ...
                        while($row=mysqli_fetch_array($selectAll)){
                            ...
                            echo "<form action='' method='POST'>"?>
                                    ...
                                    <td><button type='submit' name='yes' class='btn btn-success'>Approve</button></td>
                                    <td><button type='submit' name='no' class='btn btn-danger'>Deny</button></td>

                        <?php
                               echo "<input type='hidden' name='date_id' value='".$row['date_id']."'/>
                                  </tr>
                                </form>
                                 ";
                            $counter++;
                        ...
                        if(isset($_POST['yes'])){
                            ...
                            $yes=$conn->query("UPDATE date_tbl SET ordertype=1 WHERE date_id='$dateID'");
                            ...
                            if(!$yes){
                                ...
                                die("<script>
                                        alert('Reservation successfuly labeled as Approve');
                                        window.location.href='reservation.php';
                                     </script>");
                            }
                        }
                        ...
                        if(isset($_POST['no'])){
                            ...
                            $no=$conn->query("UPDATE date_tbl SET ordertype=2 WHERE date_id='$dateID'");
                            ...
                            if(!$no){
                                ...
                                die("<script>
                                        alert('Reservation successfuly labeled as Deny');
                                        window.location.href='reservation.php';
                                     </script>");
                            }
                        }
            ...
            <div>
                ...
                <?php
                    $selectAll=$conn->query("SELECT client_tbl.*, date_tbl.* FROM client_tbl, date_tbl WHERE ordertype=0 AND client_order='baptism' AND client_tbl.client_id=date_tbl.client_id");
            ...
            <div>
                ...
                <?php
                    $selectAll=$conn->query("SELECT client_tbl.*, date_tbl.* FROM client_tbl, date_tbl WHERE ordertype=0 AND client_order='funeral' AND client_tbl.client_id=date_tbl.client_id");
            ...
            <div>
                ...
                <?php
                    $selectAll=$conn->query("SELECT client_tbl.*, date_tbl.* FROM client_tbl, date_tbl WHERE ordertype=0 AND client_order='mass' AND client_tbl.client_id=date_tbl.client_id");
